      ...
      <Link to="/statistics" className="menu-item">
        <i>
          <svg
            ...
            fill="currentColor"
          >
            <path d="M5 9c-.55 0-1 .45-1 1v9c0 .55.45 1 1 1s1-.45 1-1v-9c0-.55-.45-1-1-1zm7-5c-.55 0-1 .45-1 1v14c0 .55.45 1 1 1s1-.45 1-1V5c0-.55-.45-1-1-1zm7 9c-.55 0-1 .45-1 1v5c0 .55.45 1 1 1s1-.45 1-1v-5c0-.55-.45-1-1-1z" />
          </svg>
        </i>
